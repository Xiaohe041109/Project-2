...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"High", None))
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"Low", None))
